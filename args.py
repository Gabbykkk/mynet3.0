...
def get_parser():
    ...
    parser.add_argument('--try_id', default='lavt', help='name to identify the try')
    ...
    parser.add_argument('--tensorboard_path', default='./runs/logs', help='the path of tensorboard',)
